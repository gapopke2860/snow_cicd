...
CREATE TABLE DEALERSHIPS.stg_carobar.CAR_SALE (
...
CREATE TABLE DEALERSHIPS.stg_carobar.CLICK_DATAs (
	_FIVETRAN_ID VARCHAR(256) NOT NULL,
...
CREATE TABLE DEALERSHIPS.stg_carobar.CUSTOMERs (
	_FIVETRAN_ID VARCHAR(256) NOT NULL,
	CUSTOMER_ID VARCHAR(50),
...
CREATE TABLE DEALERSHIPS.stg_carobar.CUSTOMER_COMPLAINTs (
	_FIVETRAN_ID VARCHAR(256) NOT NULL,
	CUSTOMER_ID VARCHAR(50),
...
CREATE TABLE DEALERSHIPS.stg_carobar.DEALER_MASTERs (
	_FIVETRAN_ID VARCHAR(256) NOT NULL,
	CITY VARCHAR(50),
	DEALERS VARCHAR(50),
...
CREATE TABLE DEALERSHIPS.stg_carobar.EMPLOYEEs (
	_FIVETRAN_ID VARCHAR(256) NOT NULL,
	EMP_ID VARCHAR(50),
...
CREATE TABLE DEALERSHIPS.stg_carobar.FEATURE_DATAs (
...
CREATE TABLE DEALERSHIPS.stg_carobar.FEATURE_MASTERs (
	_FIVETRAN_ID VARCHAR(256) NOT NULL,
...
CREATE TABLE DEALERSHIPS.stg_carobar.GENERIC_CAR_ATTRIBUTEs (
	_FIVETRAN_ID VARCHAR(256) NOT NULL,
	DOORS NUMBER(38,0),
...
CREATE TABLE DEALERSHIPS.stg_carobar.INDIVDUAL_CAR_ATTRIBUTE (
	SOLD VARCHAR(50),
	CAR_TYPE VARCHAR(50),
	YEAR NUMBER(38,0),
...
CREATE TABLE DEALERSHIPS.stg_carobar.MANUFACTURER_MASTER_ (
	_FIVETRAN_ID VARCHAR(256) NOT NULL,
...
CREATE TABLE DEALERSHIPS.stg_carobar.MANUFACTURER_MASTER (
...
CREATE TABLE DEALERSHIPS.stg_carobar.POSTPURCHASESURVEYs (
	_FIVETRAN_ID VARCHAR(256) NOT NULL,
	FUEL_TYPE VARCHAR(50),
	CAR_VERSION_ID VARCHAR(50),
...
CREATE TABLE DEALERSHIPS.stg_carobar.TEST_DRIVE (
	ID VARCHAR(18) NOT NULL,
	OWNER_ID VARCHAR(18),
	IS_DELETED BOOLEAN,
	CREATED_DATE TIMESTAMP_TZ(9),
