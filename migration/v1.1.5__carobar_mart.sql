...
CREATE TRANSIENT TABLE DEALERSHIPS.MART_CAROBAR.CAR_SALES_FACT (
...
CREATE TRANSIENT TABLE DEALERSHIPS.MART_CAROBAR.CLICK_DATA_FACT (
	CAR_ID VARCHAR(50),
	DEALER_ID VARCHAR(50),
	FILTERS VARCHAR(50),
...
CREATE TRANSIENT TABLE DEALERSHIPS.MART_CAROBAR.CUSTOMER_COMPLAINT_FACT (
	CUSTOMER_ID VARCHAR(50),
	DEALER_ID VARCHAR(50),
	CAR_VERSION_ID VARCHAR(50),
...
CREATE TRANSIENT TABLE DEALERSHIPS.MART_CAROBAR.CUSTOMER_FACT (
	CUSTOMER_ID VARCHAR(50),
	DEALER_ID VARCHAR(50),
	SUBDEALER_ID VARCHAR(50),
...
CREATE TRANSIENT TABLE DEALERSHIPS.MART_CAROBAR.DIM_DEALER_MASTER (
	DEALER_ID VARCHAR(50),
	CAR_VERSION_ID VARCHAR(50),
	SUBDEALER_ID VARCHAR(50),
	DEALERS VARCHAR(50),
...
CREATE TRANSIENT TABLE DEALERSHIPS.MART_CAROBAR.DIM_EMPLOYEE (
	EMP_ID VARCHAR(50),
	DEALER_ID VARCHAR(50),
	SUBDEALER_ID VARCHAR(50),
...
CREATE TRANSIENT TABLE DEALERSHIPS.MART_CAROBAR.DIM_FEATURE_DATA (
...
CREATE TRANSIENT TABLE DEALERSHIPS.MART_CAROBAR.DIM_FEATURE_MASTER (
...
CREATE TRANSIENT TABLE DEALERSHIPS.MART_CAROBAR.DIM_GENERIC_CAR_ATTRIBUTE (
...
CREATE TRANSIENT TABLE DEALERSHIPS.MART_CAROBAR.DIM_INDIVIDUAL_CAR_ATTRIBUTES (
	CAR_ID VARCHAR(50),
	CAR_TYPE VARCHAR(50),
	CAR_VERSION_ID VARCHAR(50),
	SUBDEALER_ID VARCHAR(50),
...
CREATE TRANSIENT TABLE DEALERSHIPS.MART_CAROBAR.DIM_MANUFACTURER_MASTER (
	DEALER_ID VARCHAR(50),
...
CREATE TRANSIENT TABLE DEALERSHIPS.MART_CAROBAR.DIM_POSTPURCHASESURVEY (
	CAR_TYPE VARCHAR(50),
	DEALER_ID VARCHAR(50),
	CAR_VERSION_ID VARCHAR(50),
	FUEL_TYPE VARCHAR(50),
...
CREATE TRANSIENT TABLE DEALERSHIPS.MART_CAROBAR.TEST_DRIVES_FACT (
