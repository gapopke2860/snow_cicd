...
create or replace TABLE DEALERSHIPS.STAGE_CAROBAR.CAR_SALES (
...
create or replace TABLE DEALERSHIPS.STAGE_CAROBAR.CLICK_DATA (
	_FIVETRAN_ID VARCHAR(256) NOT NULL,
...
create or replace TABLE DEALERSHIPS.STAGE_CAROBAR.CUSTOMER (
	_FIVETRAN_ID VARCHAR(256) NOT NULL,
	CUSTOMER_ID VARCHAR(50),
...
create or replace TABLE DEALERSHIPS.STAGE_CAROBAR.CUSTOMER_COMPLAINT (
	_FIVETRAN_ID VARCHAR(256) NOT NULL,
	CUSTOMER_ID VARCHAR(50),
...
create or replace TABLE DEALERSHIPS.STAGE_CAROBAR.DEALER_MASTER (
	_FIVETRAN_ID VARCHAR(256) NOT NULL,
	CITY VARCHAR(50),
	DEALERS VARCHAR(50),
...
create or replace TABLE DEALERSHIPS.STAGE_CAROBAR.EMPLOYEE (
	_FIVETRAN_ID VARCHAR(256) NOT NULL,
	EMP_ID VARCHAR(50),
...
create or replace TABLE DEALERSHIPS.STAGE_CAROBAR.FEATURE_DATA (
...
create or replace TABLE DEALERSHIPS.STAGE_CAROBAR.FEATURE_MASTER (
	_FIVETRAN_ID VARCHAR(256) NOT NULL,
...
create or replace TABLE DEALERSHIPS.STAGE_CAROBAR.GENERIC_CAR_ATTRIBUTE (
	_FIVETRAN_ID VARCHAR(256) NOT NULL,
	DOORS NUMBER(38,0),
...
create or replace TABLE DEALERSHIPS.STAGE_CAROBAR.INDIVDUAL_CAR_ATTRIBUTES (
	SOLD VARCHAR(50),
	CAR_TYPE VARCHAR(50),
	YEAR NUMBER(38,0),
...
create or replace TABLE DEALERSHIPS.STAGE_CAROBAR.MANUFACTURER_MASTER_C (
...
create or replace TABLE DEALERSHIPS.STAGE_CAROBAR.POSTPURCHASESURVEY (
	_FIVETRAN_ID VARCHAR(256) NOT NULL,
	FUEL_TYPE VARCHAR(50),
	CAR_VERSION_ID VARCHAR(50),
...
create or replace TABLE DEALERSHIPS.STAGE_CAROBAR.TEST_DRIVES (
	ID VARCHAR(18) NOT NULL,
	OWNER_ID VARCHAR(18),
	IS_DELETED BOOLEAN,
	CREATED_DATE TIMESTAMP_TZ(9),
