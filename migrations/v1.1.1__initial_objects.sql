...
create or replace TABLE DEALERSHIPS.STAGE_CAROBAR.CAR_SALE (
...
create or replace TABLE DEALERSHIPS.STAGE_CAROBAR.CLICK_DATAs (
	_FIVETRAN_ID VARCHAR(256) NOT NULL,
...
create or replace TABLE DEALERSHIPS.STAGE_CAROBAR.CUSTOMERs (
	_FIVETRAN_ID VARCHAR(256) NOT NULL,
	CUSTOMER_ID VARCHAR(50),
...
create or replace TABLE DEALERSHIPS.STAGE_CAROBAR.CUSTOMER_COMPLAINTs (
	_FIVETRAN_ID VARCHAR(256) NOT NULL,
	CUSTOMER_ID VARCHAR(50),
...
create or replace TABLE DEALERSHIPS.STAGE_CAROBAR.DEALER_MASTERs (
	_FIVETRAN_ID VARCHAR(256) NOT NULL,
	CITY VARCHAR(50),
	DEALERS VARCHAR(50),
...
create or replace TABLE DEALERSHIPS.STAGE_CAROBAR.EMPLOYEEs (
	_FIVETRAN_ID VARCHAR(256) NOT NULL,
	EMP_ID VARCHAR(50),
...
create or replace TABLE DEALERSHIPS.STAGE_CAROBAR.FEATURE_DATAs (
...
create or replace TABLE DEALERSHIPS.STAGE_CAROBAR.FEATURE_MASTERs (
	_FIVETRAN_ID VARCHAR(256) NOT NULL,
...
create or replace TABLE DEALERSHIPS.STAGE_CAROBAR.GENERIC_CAR_ATTRIBUTEs (
	_FIVETRAN_ID VARCHAR(256) NOT NULL,
	DOORS NUMBER(38,0),
...
create or replace TABLE DEALERSHIPS.STAGE_CAROBAR.INDIVDUAL_CAR_ATTRIBUTE (
	SOLD VARCHAR(50),
	CAR_TYPE VARCHAR(50),
	YEAR NUMBER(38,0),
...
create or replace TABLE DEALERSHIPS.STAGE_CAROBAR.MANUFACTURER_MASTER_ (
	_FIVETRAN_ID VARCHAR(256) NOT NULL,
...
create or replace TABLE DEALERSHIPS.STAGE_CAROBAR.MANUFACTURER_MASTER (
...
create or replace TABLE DEALERSHIPS.STAGE_CAROBAR.POSTPURCHASESURVEYs (
	_FIVETRAN_ID VARCHAR(256) NOT NULL,
	FUEL_TYPE VARCHAR(50),
	CAR_VERSION_ID VARCHAR(50),
...
create or replace TABLE DEALERSHIPS.STAGE_CAROBAR.TEST_DRIVE (
	ID VARCHAR(18) NOT NULL,
	OWNER_ID VARCHAR(18),
	IS_DELETED BOOLEAN,
	CREATED_DATE TIMESTAMP_TZ(9),
